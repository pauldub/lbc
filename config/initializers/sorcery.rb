...
Rails.application.config.sorcery.submodules = [:remember_me, :external, :activity_logging, :brute_force_protection, :session_timeout]
...
Rails.application.config.sorcery.configure do |config|
  ...
  # Default: `[]`
  #
  config.external_providers = [:twitter, :github, :google]
